const onlineCoaching = {
    ...
    tagLine: "You want to get the results that you’ve been aiming for all along?",
    ...
    wants: [
        ...
        "...see amazing results in a matter of weeks?",
        "...get amazing results without giving up your social life?",
    ],
    find: "Find out more...",
    title_2: "What's included in the program?",
    cards: [
        {
